...
const UserNotificationBox = ({
  ...
  const renderNotifications = () => {
    if (notifications.length >= 3) {
      return (
        <div className="relative z-30 mb-5 h-40 w-5/6 rounded-md border border-orange-500 bg-gradient-to-r from-gray-200 to-gray-300 drop-shadow-lg dark:from-gray-500 dark:to-gray-700">
