...
declare namespace Paths {
  ...
  namespace AddFollowing {
    ...
    namespace Responses {
      export type $200 =
        /* User following other user or group. */ Components.Schemas.UserFollow;
      export type $400 = Components.Schemas.ErrorResponse;
    }
  }
...
export interface OperationMethods {
  ...
  "getBlogPost"(
    parameters?: Parameters<
      Paths.GetBlogPost.QueryParameters & Paths.GetBlogPost.PathParameters
    > | null,
    data?: any,
  ...
  "addFollowing"(
    parameters?: Parameters<
      Paths.AddFollowing.QueryParameters & Paths.AddFollowing.PathParameters
    > | null,
    data?: any,
    config?: AxiosRequestConfig
